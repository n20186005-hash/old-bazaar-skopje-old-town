...
const photos = [
  { src: '/gallery/images (1).jpg', alt: 'Old Bazaar panoramic view' },
  { src: '/gallery/images (2).jpg', alt: 'Cobblestone alley' },
  { src: '/gallery/images (3).jpg', alt: 'Mustafa Pasha Mosque' },
  { src: '/gallery/images (4).jpg', alt: 'Caravanserai courtyard' },
  { src: '/gallery/images (5).jpg', alt: 'Traditional handicraft shop' },
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="relative">
            ...
            <div className="flex justify-center mt-6 gap-4 items-center">
              <a
                href="https://maps.app.goo.gl/t39pvPGR2S68j9vj6"
                target="_blank"
